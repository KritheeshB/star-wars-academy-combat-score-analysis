...
df['Midichlorian_Count'] = df['Midichlorian_Count'].fillna(0)   
df['Lightsaber_Color']   = df['Lightsaber_Color'].fillna('None')

#Age - fill missing with median (excluding Yoda)
median_age = df[df['Name'] != 'Yoda']['Age'].median()
